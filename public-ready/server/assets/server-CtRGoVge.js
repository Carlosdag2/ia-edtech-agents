...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-B4g80vWk.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DB1qw0_-.js"),
    import("./start-BnmqHZTr.js"),
...
var ROUTER_BASEPATH = "oficina-agentica-edtech";
var SERVER_FN_BASE = "/oficina-agentica-edtech/_serverFn/";
